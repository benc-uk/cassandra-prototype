...
export TEST_API_ENDPOINT=https://proto-test.kube.benco.io
export TEST_STAGE_TIME=25
...
k6 run $DIR/loadtest.js --summary-export "results_$(date +"%m-%d-%y_%k-%M").json" --tag foo=hello
#--out influxdb=http://${INFLUXDB_IP}:8086/k6_results
